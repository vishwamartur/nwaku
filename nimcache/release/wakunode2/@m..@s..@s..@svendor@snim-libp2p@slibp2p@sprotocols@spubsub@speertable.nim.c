...
N_LIB_PRIVATE N_NIMCALL(void, removePeer__2S3XoG45YC54E3eCQ6VcfA)(tyObject_Table__t1GIbsENi89cp9cMuggZaXQg* table, NimStringDesc* topic, tyObject_PubSubPeercolonObjectType___6rsvBHOjeRkx0KPoUqsmsw* peer) {	NI hcX60gensym116455851_;	NI indexX60gensym116455852_;	NIM_BOOL hasKeyX60gensym116455853_;	hcX60gensym116455851_ = (NI)0;
#line 607 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/pure/collections/tables.nim"

#line 607 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/pure/collections/tables.nim"
	indexX60gensym116455852_ = rawGet__PM9btsJmhNOJ7EUfpwXlHZwtables((*table), topic, (&hcX60gensym116455851_));
#line 608 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/pure/collections/tables.nim"

#line 608 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/pure/collections/tables.nim"
	hasKeyX60gensym116455853_ = (((NI) 0) <= indexX60gensym116455852_);
#line 31 "/home/runner/work/nim-waku/nim-waku/vendor/nim-libp2p/libp2p/protocols/pubsub/peertable.nim"
	{		tyObject_HashSet__SjkKNmUxUCmHfJyMk9aPJ9cw* peers;		if (!hasKeyX60gensym116455853_) goto LA3_;

#line 31 "/home/runner/work/nim-waku/nim-waku/vendor/nim-libp2p/libp2p/protocols/pubsub/peertable.nim"
		if ((NU)(indexX60gensym116455852_) >= (NU)((*table).data ? (*table).data->Sup.len : 0)){ raiseIndexError2(indexX60gensym116455852_,((*table).data ? (*table).data->Sup.len : 0)-1); }		peers = (&(*table).data->data[indexX60gensym116455852_].Field2);
