...
N_LIB_PRIVATE N_NIMCALL(NI, olen__0dw7gZET9cKXvkxNm43MHRA)(NimStringDesc* s, NI start, NI lastExclusive);
...
N_LIB_PRIVATE N_NIMCALL(NI, olen__0dw7gZET9cKXvkxNm43MHRA)(NimStringDesc* s, NI start, NI lastExclusive) {	NI result;	NI i;	result = (NI)0;
...
#line 19 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/std/wordwrap.nim"
			L = graphemeLen__PLnPtAcI9ac8BvVcA3e5o7w(s, ((NI) (i)));
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, wrapWords__T8gYSir9ao1V9bYDExwUzAPg)(NimStringDesc* s, NI maxLineWidth, NIM_BOOL splitLongWords, tySet_tyChar__nmiMWKVIe46vacnhAFrQvw seps, NimStringDesc* newLine) {	NimStringDesc* result;	NI TM__IobAM6Jeru9cnaKaai8r4Ug_2;	NI spaceLeft;	NimStringDesc* lastSep;	NI i;	result = (NimStringDesc*)0;
...
#line 32 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/std/wordwrap.nim"
	if (nimAddInt((s ? s->Sup.len : 0), (NI)((NI64)((s ? s->Sup.len : 0)) >> (NU64)(((NI) 6))), &TM__IobAM6Jeru9cnaKaai8r4Ug_2)) { raiseOverflow(); };	if (((NI)(TM__IobAM6Jeru9cnaKaai8r4Ug_2)) < ((NI) 0) || ((NI)(TM__IobAM6Jeru9cnaKaai8r4Ug_2)) > ((NI) IL64(9223372036854775807))){ raiseRangeErrorI((NI)(TM__IobAM6Jeru9cnaKaai8r4Ug_2), ((NI) 0), ((NI) IL64(9223372036854775807))); }
#line 32 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/std/wordwrap.nim"
...
#line 39 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/std/wordwrap.nim"
			T3_ = (j < (s ? s->Sup.len : 0));			if (!(T3_)) goto LA4_;

#line 39 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/std/wordwrap.nim"
			if ((NU)(j) >= (NU)(s ? s->Sup.len : 0)){ raiseIndexError2(j,(s ? s->Sup.len : 0)-1); }			T3_ = ((seps[(NU)(((NU8)(s->data[j])))>>3] &(1U<<((NU)(((NU8)(s->data[j])))&7U)))!=0);			LA4_: ;
			isSep = T3_;			{
...
#line 40 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/std/wordwrap.nim"
					T7_ = (j < (s ? s->Sup.len : 0));					if (!(T7_)) goto LA8_;

#line 40 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/std/wordwrap.nim"

#line 40 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/std/wordwrap.nim"
					if ((NU)(j) >= (NU)(s ? s->Sup.len : 0)){ raiseIndexError2(j,(s ? s->Sup.len : 0)-1); }					T7_ = (((seps[(NU)(((NU8)(s->data[j])))>>3] &(1U<<((NU)(((NU8)(s->data[j])))&7U)))!=0) == isSep);					LA8_: ;
					if (!T7_) goto LA6;
...
#line 46 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/std/wordwrap.nim"
								if ((NU)(k) >= (NU)(s ? s->Sup.len : 0)){ raiseIndexError2(k,(s ? s->Sup.len : 0)-1); }								if (!!((((NU8)(s->data[k])) == ((NU8)(10)) || ((NU8)(s->data[k])) == ((NU8)(13))))) goto LA22_;

#line 46 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/std/wordwrap.nim"
								if ((NU)(k) >= (NU)(s ? s->Sup.len : 0)){ raiseIndexError2(k,(s ? s->Sup.len : 0)-1); }								lastSep = addChar(lastSep, s->data[k]);							}
							LA22_: ;
...
#line 53 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/std/wordwrap.nim"
				wlen = olen__0dw7gZET9cKXvkxNm43MHRA(s, i, j);
...
#line 62 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/std/wordwrap.nim"
								L = graphemeLen__PLnPtAcI9ac8BvVcA3e5o7w(s, ((NI) ((NI)(TM__IobAM6Jeru9cnaKaai8r4Ug_11))));								{									NI m;									NI colontmp_;									NI i_3;									m = (NI)0;									colontmp_ = (NI)0;
...
#line 63 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/std/wordwrap.nim"
											if (nimAddInt(i, k_2, &TM__IobAM6Jeru9cnaKaai8r4Ug_12)) { raiseOverflow(); };											if (nimAddInt((NI)(TM__IobAM6Jeru9cnaKaai8r4Ug_12), m, &TM__IobAM6Jeru9cnaKaai8r4Ug_13)) { raiseOverflow(); };											if ((NU)((NI)(TM__IobAM6Jeru9cnaKaai8r4Ug_13)) >= (NU)(s ? s->Sup.len : 0)){ raiseIndexError2((NI)(TM__IobAM6Jeru9cnaKaai8r4Ug_13),(s ? s->Sup.len : 0)-1); }											result = addChar(result, s->data[(NI)(TM__IobAM6Jeru9cnaKaai8r4Ug_13)]);
#line 109 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/system/iterators_1.nim"
...
#line 68 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/std/wordwrap.nim"
									k_3 = i_4;
#line 68 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/std/wordwrap.nim"
									if ((NU)(k_3) >= (NU)(s ? s->Sup.len : 0)){ raiseIndexError2(k_3,(s ? s->Sup.len : 0)-1); }									result = addChar(result, s->data[k_3]);
#line 109 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/system/iterators_1.nim"
...
#line 72 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/std/wordwrap.nim"
								k_4 = i_5;
#line 72 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/std/wordwrap.nim"
								if ((NU)(k_4) >= (NU)(s ? s->Sup.len : 0)){ raiseIndexError2(k_4,(s ? s->Sup.len : 0)-1); }								result = addChar(result, s->data[k_4]);
#line 109 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/system/iterators_1.nim"
