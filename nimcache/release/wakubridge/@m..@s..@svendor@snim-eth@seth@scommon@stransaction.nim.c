...
#line 72 "/home/runner/work/nim-waku/nim-waku/vendor/nim-eth/eth/common/transaction.nim"
	result = digest__kUuxyH0Wbp0DnT9anHK9b9c2g(T1_->data, (T1_ ? T1_->Sup.len : 0));	goto BeforeRet_;
	}BeforeRet_: ;
	return result;}
