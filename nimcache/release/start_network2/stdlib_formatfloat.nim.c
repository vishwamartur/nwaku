...
#define nimfr_(x, y)
#define nimln_(x, y)
N_LIB_PRIVATE N_NIMCALL(void, writeToBuffer__Nntp3gW9b170LCR9cOWNy1tg)(NIM_CHAR* buf_0, NCSTRING value_0);

#line 13 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/system/formatfloat.nim"
N_LIB_PRIVATE N_NIMCALL(void, writeToBuffer__Nntp3gW9b170LCR9cOWNy1tg)(NIM_CHAR* buf_0, NCSTRING value_0) {	NI i;
...
#line 15 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/system/formatfloat.nim"
			if (!!(((NU8)(value_0[i]) == (NU8)(0)))) goto LA2;
...
N_LIB_PRIVATE N_NIMCALL(NI, writeFloatToBuffer__UrA9aquvUwHFUFx78eUQk3A)(NIM_CHAR* buf_0, NF value_0) {	NI result;	NI n_1;	int T1_;	NIM_BOOL hasDot;	result = (NI)0;
#line 32 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/system/formatfloat.nim"

#line 32 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/system/formatfloat.nim"

#line 32 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/system/formatfloat.nim"
	T1_ = (int)0;	T1_ = sprintf(((NCSTRING) (buf_0)), "%.16g", value_0);	n_1 = ((NI) (T1_));
...
#line 35 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/system/formatfloat.nim"
				{
#line 35 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/system/formatfloat.nim"
					if (!((NU8)(buf_0[(i)- 0]) == (NU8)(44))) goto LA7_;
...
#line 38 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/system/formatfloat.nim"
					if (!(((NU8)(buf_0[(i)- 0])) >= ((NU8)(97)) && ((NU8)(buf_0[(i)- 0])) <= ((NU8)(122)) || ((NU8)(buf_0[(i)- 0])) >= ((NU8)(65)) && ((NU8)(buf_0[(i)- 0])) <= ((NU8)(90)) || ((NU8)(buf_0[(i)- 0])) == ((NU8)(46)))) goto LA10_;
...
#line 50 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/system/formatfloat.nim"
		if (!(((NU8)(buf_0[((NI)(n_1 - ((NI) 1)))- 0])) == ((NU8)(110)) || ((NU8)(buf_0[((NI)(n_1 - ((NI) 1)))- 0])) == ((NU8)(78)) || ((NU8)(buf_0[((NI)(n_1 - ((NI) 1)))- 0])) == ((NU8)(68)) || ((NU8)(buf_0[((NI)(n_1 - ((NI) 1)))- 0])) == ((NU8)(100)) || ((NU8)(buf_0[((NI)(n_1 - ((NI) 1)))- 0])) == ((NU8)(41)))) goto LA19_;

#line 51 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/system/formatfloat.nim"

#line 51 "/home/runner/work/nim-waku/nim-waku/vendor/nimbus-build-system/vendor/Nim/lib/system/formatfloat.nim"
		writeToBuffer__Nntp3gW9b170LCR9cOWNy1tg(buf_0, "nan");
