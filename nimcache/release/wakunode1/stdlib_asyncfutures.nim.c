...
static N_NIMCALL(void, Marker_tyRef__TjokxNjmnZmr9bygVDVC9bvg)(void* p, NI op) {
	...
	nimGCvisit((void*)(*a).Sup.callbacks.function.ClE_0, op);	nimGCvisit((void*)(*a).Sup.callbacks.next, op);	nimGCvisit((void*)(*a).Sup.error, op);	nimGCvisit((void*)(*a).Sup.errorStackTrace, op);}
...
static TNimNode TM__vnqLhdH9cCREQ2r9aXVOqbvQ_0[12];NTI__Ig6kXMs9apW5862wHsbFhGw_.size = sizeof(tyTuple__JfHvHzMrhKkWAUvQKe0i1A);
NTI__Ig6kXMs9apW5862wHsbFhGw_.kind = 18;
NTI__Ig6kXMs9apW5862wHsbFhGw_.base = 0;
NTI__Ig6kXMs9apW5862wHsbFhGw_.name = "tuple of (pointer, ref object)";
NTI__Ig6kXMs9apW5862wHsbFhGw_.nextType = nimTypeRoot; nimTypeRoot=&NTI__Ig6kXMs9apW5862wHsbFhGw_;
...
NTI__NMMT5akQkfNlmjYrVF9a9bwA_.name = "FutureBase:ObjectType";
NTI__NMMT5akQkfNlmjYrVF9a9bwA_.nextType = nimTypeRoot; nimTypeRoot=&NTI__NMMT5akQkfNlmjYrVF9a9bwA_;
...
NTI__tKSBWiaJMWD3JZxwqg7UFQ_.name = "CallbackList";
NTI__tKSBWiaJMWD3JZxwqg7UFQ_.nextType = nimTypeRoot; nimTypeRoot=&NTI__tKSBWiaJMWD3JZxwqg7UFQ_;
...
NTI__gcUT3qWwCET3KjsqW7m5vQ_.name = "ref CallbackList";
NTI__gcUT3qWwCET3KjsqW7m5vQ_.nextType = nimTypeRoot; nimTypeRoot=&NTI__gcUT3qWwCET3KjsqW7m5vQ_;
...
NTI__te3W2Tqi7xuJ7rlPtg9al5w_.name = "Future[system.void]";
NTI__te3W2Tqi7xuJ7rlPtg9al5w_.nextType = nimTypeRoot; nimTypeRoot=&NTI__te3W2Tqi7xuJ7rlPtg9al5w_;
...
NTI__TjokxNjmnZmr9bygVDVC9bvg_.name = "Future[system.void]";
NTI__TjokxNjmnZmr9bygVDVC9bvg_.nextType = nimTypeRoot; nimTypeRoot=&NTI__TjokxNjmnZmr9bygVDVC9bvg_;
